...
<head>
    ...
    <title>Feedback - Journey Mate</title>
    ...
    <div class="w3-container w3-row w3-row-padding">
        ...
        <div class="w3-panel w3-third w3-padding w3-card-4 w3-round-large w3-white ">
            <div class="w3-panel w3-padding w3-center ">
                <h1 class="w3-padding w3-large w3-text-indigo " id="txthead"><b>Feedback</b></h1>
                <form class="w3-container w3-small" method="post" action="inc/feedback.inc.php">
                    <label class="w3-text-red "><b>Name : &nbsp; &nbsp; &nbsp; &nbsp; </b></label>
                    <input type="text" value="<?php echo $name; ?>" name="name" class="w3-panel w3-border w3-center w3-padding w3-round-large w3-border-blue " autocomplete="off" placeholder="Enter Your Name">
                    <br>
                    ...
                    <input type="text" name="feedback" value="<?php echo $feed; ?>" class="w3-panel w3-border w3-center w3-padding w3-round-large w3-border-blue " placeholder="Enter Your Feedback"><br>
